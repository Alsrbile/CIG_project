...
from .mask_dropout import MaskingDropout
from ..model.sdxl_shared_attn import register_shared_attn
...
class CustomStableDiffusionXLPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.attention_store = MaskingDropout(attention_store_kwargs)
        register_shared_attn(self.unet, self.attention_store)
